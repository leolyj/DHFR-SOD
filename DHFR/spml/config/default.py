...
config.train.feat_crf_loss_weight= 0.0
config.train.l1_crf_loss_weight= 0.0
config.train.parted_ce_loss_weight= 0.0
config.train.ssc_loss_weight= 0.0
